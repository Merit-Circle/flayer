              ...
              <fieldset>
                ...
                <div class="spread-content">
                  <div class="label-align">
                    ...
                    <select
                      ...
                      v-model.number="selectedPixelateImageZoom"
                    >
                      <option
                        v-for="(pixelateZoom, index) in pixelateImageZooms"
                        :value="index"
                        :key="index"
                      >
                        {{ imageFilterSteppedDropdownOption(index) }}
                      </option>
                    </select>
                  </div>
                  <cycle-property-list
                    ...
                    :array-length="pixelateImageZooms.length"
                  />
                </div>
                <div class="spread-content" v-if="areCanvasFiltersEnabled">
                  <div class="label-align">
                    ...
                    <select
                      ...
                      v-model.number="selectedImageBrightnessIndex"
                    >
                      <option
                        v-for="(percentage, index) in canvasFilterValues"
                        :value="index"
                        :key="index"
                      >
                        {{ `${percentage}%` }}
                ...
                <div class="spread-content" v-if="areCanvasFiltersEnabled">
                  <div class="label-align">
                    ...
                    <select
                      ...
                      v-model.number="selectedImageContrastIndex"
                    >
                      <option
                        v-for="(percentage, index) in canvasFilterValues"
                        :value="index"
                ...
                <div class="spread-content" v-if="areCanvasFiltersEnabled">
                  <div class="label-align">
                    ...
                    <select
                      ...
                      v-model.number="selectedImageSaturationIndex"
                    >
                      <option
                        v-for="(percentage, index) in canvasFilterValues"
                        :value="index"
                ...
                <div class="spread-content" v-if="isWebglEnabled">
                  <div class="label-align">
                    ...
                    >
                      <option
                        v-for="(value, index) in bilateralFilterValues"
                        :value="index"
                        :key="index"
                      >
                        {{ imageFilterSteppedDropdownOption(index) }}
                ...
                <div class="spread-content" v-if="isSmoothingEnabled">
                  <div class="label-align">
                    ...
                    >
                      <option
                        v-for="(smoothingValue, index) in imageSmoothingValues"
                        :value="index"
                        :key="index"
                      >
                        {{ imageFilterSteppedDropdownOption(smoothingValue) }}
                      </option>
                    </select>
                  </div>
                  <cycle-property-list
...
export default {
  ...
  created() {
    ...
    if (!transformCanvasWebGl.supportsHighIntPrecision) {
      ...
      this.bwDitherAlgorithms = this.bwDitherAlgorithms.map(
        removeUnsupportedWebGl
      );
      this.colorDitherAlgorithms = this.colorDitherAlgorithms.map(
        removeUnsupportedWebGl
      );
    }
  },
  ...
  data() {
    return {
       ...
       * Filters
       */
      selectedPixelateImageZoom: 8, // 8x
      //smoothing
      ...
      selectedImageSaturationIndex: 16, // 105%
  ...
  computed: {
    ...
    isColorPickerLivePreviewEnabled() {
      return (
        this.isLivePreviewEnabled && this.isColorPickerLivePreviewEnabledSetting
      );
    },
    isImageLoaded() {
  ...
  methods: {
    ...
    onSaveRequested(exportCanvas, shouldUpsample, callback) {
      ...
      const scale =
        this.isImagePixelated && shouldUpsample
    ...
    imageFiltersBeforeDitherChanged(notifyDitherSection = true) {
      ...
      if (this.isWebglEnabled) {
        ...
        hasImageBeenTransformed =
          this.bilateralFilterValueBeforeChanged() || hasImageBeenTransformed;
        hasImageBeenTransformed =
          this.imageSmoothingBeforeChanged() || hasImageBeenTransformed;
    ...
    bilateralFilterValueBeforeChanged() {
      const filterExponent =
        this.bilateralFilterValues[this.selectedBilateralFilterValueBefore];
      if (filterExponent < 0) {
        return false;
      }
      const imageHeader = this.imageHeader;
    ...
    imageSmoothingBeforeChanged() {
      const smoothingRadius =
        this.imageSmoothingValues[this.selectedImageSmoothingRadiusBefore];
    ...
    imageSmoothingAfterChanged() {
      const smoothingRadius =
        this.imageSmoothingValues[this.selectedImageSmoothingRadiusAfter];
      if (!this.isSmoothingEnabled || smoothingRadius <= 0) {
        return false;
      }
      const imageHeader = this.imageHeader;
    ...
    bilateralFilterValueAfterChanged() {
      const filterExponent =
        this.bilateralFilterValues[this.selectedBilateralFilterValueAfter];
      if (filterExponent < 0) {
        return false;
      }
      const imageHeader = this.imageHeader;
    ...
    imageFiltersAfterDitherChanged() {
      ...
      let hasImageBeenTransformed = false;
      hasImageBeenTransformed =
        this.bilateralFilterValueAfterChanged() || hasImageBeenTransformed;
      hasImageBeenTransformed =
    ...
    onDimensionsRequestedForZoomFit(callback) {
      ...
      const canvasMargin = this.showOriginalImage
        ? parseInt(
            getComputedStyle(
              this.$refs.imageCanvasSupercontainer.sourceCanvasOutput
            )
